...
<body class="h-100 d-flex flex-column h-100">
    ...
    <div id="body">
        ...
        <div class="container-lg mb-5">
            <h2 class="minTl">Giới thiệu chung</h2>
            <div class="row">
                <div class="col-md-8 col-sm-8">
                    <div class="tlsolid mb-3 h3">Sứ mệnh</div>
                    <div class="mgt20 text-justify">
                        <p style="text-align: justify"><b>
                                Ban liên lạc Cựu sinh viên Trường Đại học Kỹ thuật Công nghiệp, Đại học Thái Nguyên là
                                kênh
                                kết nối chặt chẽ giữa Nhà trường với các Cựu sinh viên trong và ngoài nước. Qua đó tăng
                                cường cơ hội hợp tác, gắn kết, nhằm nâng cao nhận thức, niềm tự hào truyền thống, chia
                                sẻ
                                các giá trị, năng lực và thế mạnh của các Cựu sinh viên cũng như hỗ trợ cho Nhà trường.
                                Thực
                                hiện tốt sứ mệnh “Cơ sở đào tạo nguồn nhân lực chất lượng cao; nghiên cứu khoa học; tư
                                vấn,
                                ứng dụng và chuyển giao công nghệ đáp ứng yêu cầu phát triển bền vững của đất nước và
                                hội
                                nhập quốc tế”.</b></p>
                        ...
                        <br><br>
                        <div class="tlsolid mb-3 h3">Mục tiêu</div>
                        <ul>
                            <li>- Phát huy niềm tự hào, sự đoàn kết, gắn bó, hỗ trợ lẫn nhau giữa các Cựu sinh viên và
                                làm cầu nối hiệu quả giữa các Cựu sinh viên với cán bộ, giảng viên, sinh viên hiện tại
                                của Trường Đại học Kỹ thuật Công nghiệp;</li>
                            <li>- Mở rộng và triển khai hiệu quả việc kết nối mạng lưới Cựu sinh viên tại tất cả các
                                tỉnh thành trong cả nước;</li>
                            <li>- Tăng cường sự hợp tác, ủng hộ và phát huy các nguồn lực từ mạng lưới Cựu sinh viên.
                            </li>
                            <li>- Thành lập câu lạc bộ kết nối đầu tư và thúc đẩy mổi quan hệ Nhà trường - Doanh nghiệp
                                - Cựu sinh viên.</li>
                        </ul>
                        <div class="tlsolid mb-3 h3">Hoạt động</div>
                        <p>
                            Một trong những vai trò quan trọng của Ban liên lạc Cựu sinh viên là nhân rộng mạng lưới Cựu
                            sinh viên, tổ chức và thực hiện các sự kiện, hoạt động cho Cựu sinh viên. Các sự kiện và
                            hoạt động có thể có nhiều hình thức, nhưng về cơ bản các hoạt động hướng đến để kết nối,
                            giao lưu giữa các Cựu sinh viên, Cựu sinh viên với giảng viên cũng như với các sinh viên
                            đang học tập tại Trường. Hỗ trợ cho giảng viên, sinh viên trong các hoạt động đào tạo,
                            nghiên cứu khoa học và chuyển giao công nghệ. Các sự kiện có thể thực hiện bao gồm, nhưng
                            không giới hạn:<br>
                        <ul>
                            <li>- Các hoạt động nhân các ngày lễ kỷ niệm thành lập Khoa và thành lập Trường;
                            </li>
                            <li>- Các sự kiện xã hội kết nối giữa các Cựu sinh viên;</li>
                            <li>- Các chương trình hỗ trợ phát triển nghề nghiệp; Truyền cảm hứng cho cộng đồng Cựu
                                sinh viên và sinh viên;</li>
                            <li>- Tổ chức cho sinh viên được giao lưu, tư vấn và định hướng nghề nghiệp; giới thiệu, tạo
                                điều kiện thuận lợi cho sinh viên thực tập tốt nghiệp và trải nghiệm thực tế;</li>
                            <li>- Gây quỹ để tài trợ học bổng, giải thưởng cho các sinh viên nghèo vượt khó, hoặc cho
                                các sự kiện hoặc chương trình của Khoa và Nhà trường;</li>
                            <li>- Hỗ trợ cho các hoạt động của Khoa và Nhà trường nhằm nâng cao chất lượng giảng dạy,
                                nghiên cứu khoa học và chuyển giao công nghệ;</li>
                            <li>- Tổ chức các hoạt động giao lưu văn hoá, văn nghệ, thể thao, các buổi sinh hoạt cho Cựu
                                sinh viên nhằm tạo sự hiểu biết, đoàn kết, gắn bó giữa các thế hệ Cựu sinh viên, Cựu
                                sinh viên với Nhà trường và Cựu sinh viên với sinh viên đang học tập tại Nhà trường.
                            </li>
                        </ul>
                        </p>
                        </p>
