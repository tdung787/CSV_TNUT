    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            {{-- <li class="nav-item">
                <a class="nav-link {{ Request::routeIs('admin.abouts.*') ? '' : 'collapsed' }}"
            ...
            {{-- <li class="nav-item">
                <a class="nav-link {{ Request::routeIs('admin.recruitments.*') ? '' : 'collapsed' }}"
                    href="{{ route('admin.recruitments.index') }}">
                    <svg style="font-size: 16px; width: 20px; height: 20px; margin-right: 6px" fill="{{ Request::routeIs('admin.recruitments.*') ? '#007bff' : '#899bbd' }}"
                        version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 32.02 32.02" xml:space="preserve"
                        stroke="#828282">
                        ...
                        <g id="SVGRepo_iconCarrier">
                            <g>
                                <g>
                                    ...
                                    <rect id="XMLID_142_" x="334.311" y="148.377"
                                        transform="matrix(-0.4395 -0.8982 0.8982 -0.4395 434.9314 634.4379)"
                                        style="fill:{{ Request::routeIs('admin.partners.*') ? '#007bff' : '#899bbd' }}" width="162.188" height="66.294"></rect>
                                    <path
...
{{-- 
            <li class="nav-item">
                <a class="nav-link {{ Request::routeIs('admin.stores.*') ? '' : 'collapsed' }}"
                    href="{{ route('admin.stores.index') }}">
                    <svg style="font-size: 16px; width: 20px; height: 20px; margin-right: 6px" viewBox="0 0 24 24"
                        fill="{{ Request::routeIs('admin.stores.*') ? '#007bff' : '#899bbd' }}" xmlns="http://www.w3.org/2000/svg" stroke="{{ Request::routeIs('admin.stores.*') ? '#007bff' : '#899bbd' }}">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                ...
                                fill="{{ Request::routeIs('admin.stores.*') ? '#007bff' : '#899bbd' }}"></path>
                        </g>
                    </svg>
                    <span>Cửa hàng</span>
                </a>
            ...
            <li class="nav-item">
                <a class="nav-link cursor-pointer {{ Request::routeIs('admin.post_categories.*') || Request::routeIs('admin.posts.*') ? '' : 'collapsed' }}"
                    data-bs-target="#components-nav-1" data-bs-toggle="collapse">
                    <svg style="font-size: 16px; width: 20px; height: 20px; margin-right: 6px" fill="{{ Request::routeIs('admin.post_categories.*') || Request::routeIs('admin.posts.*') ? '#007bff' : '#899bbd' }}"
                        viewBox="-1 0 46 46" xmlns="http://www.w3.org/2000/svg">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
                            <path id="_14.News" data-name="14.News"
                                ...
                                transform="translate(-2 -1)" fill-rule="evenodd"></path>
                        </g>
                    </svg>

                    <span>Tin tức</span><i class="bi bi-chevron-down ms-auto"></i>
                </a>
                <ul id="components-nav-1"
                    class="nav-content collapse {{ Request::routeIs('admin.post_categories.*', 'admin.posts.*') ? 'show' : '' }}"
                    data-bs-parent="#sidebar-nav-1">
                    <li>
                        <a href="{{ route('admin.post_categories.index') }}"
                            class="{{ Request::routeIs('admin.post_categories.*') ? 'active' : '' }}">
            ...
            {{-- <li class="nav-item">
                <a class="nav-link cursor-pointer {{ Request::routeIs('admin.product_categories.*') || Request::routeIs('admin.products.*') || Request::routeIs('admin.comments.*') ? '' : 'collapsed' }}"
                    data-bs-target="#components-nav-2" data-bs-toggle="collapse">
                    <svg style="font-size: 16px; width: 20px; height: 20px; margin-right: 6px"
                        viewBox="-25.74 0 323.778 323.778" xmlns="http://www.w3.org/2000/svg" fill="{{ Request::routeIs('admin.product_categories.*') || Request::routeIs('admin.products.*') ? '#007bff' : '#899bbd' }}">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
                            <defs>
                                <style>
                                    .a {
                                        fill: {{ Request::routeIs('admin.product_categories.*') || Request::routeIs('admin.products.*') ? '#007bff' : '#899bbd' }};
                                    }
                            ...
                            <path class="a"
                                d="M265.123,29.778c0-11.185.049-21.9.049-26.828C249.1,2.95,14.931,2,5.532,2c0,3.949-.078,17.778-.078,27.778.4,88.183,1.305,269.892,1.305,291.005,22.951,0,237.765,1.027,258.506.994,0-20.441-.1-203.615-.142-292">
                            </path>
                            <path class="a"
                                d="M138.446,94.2c0,1.494.01,12.538.01,14.216-1.34,0-26.384-.064-27.867-.064,0-1.754-.1-13.067-.1-14.213C111.1,94.136,137.408,94.2,138.446,94.2Z">
                            </path>
                            <path class="a"
                                d="M108.021,175.736c0,1.494.011,12.538.011,14.216-1.34,0-26.384-.064-27.867-.064,0-1.754-.1-13.067-.1-14.213C80.675,175.675,106.984,175.736,108.021,175.736Z">
                            </path>
                            <path class="a"
                                d="M226.056,255.049c0,1.494.01,12.538.01,14.216-1.34,0-26.384-.064-27.866-.064,0-1.754-.1-13.067-.1-14.213C198.71,254.988,225.018,255.049,226.056,255.049Z">
                            </path>
                            <path class="b"
                                d="M157.887,180.508c-2.071.222-3.436-.69-4.82-2.247a7.421,7.421,0,0,1-1.777-5.319c.013-.123.028-.245.05-.364h-.231c-1.756.484-4.49-.957-5.569-3.026s-1.573-5.811.424-7.929a8.282,8.282,0,0,1,7.888-2.734c3.013.689,5.791,4.247,4.4,7.334,3.293-.835,7.349,2.5,7.515,6.276l.223,8Z">
                            </path>
                            <path class="c"
                                d="M66.878,175.293c3.607-2.173,6.285-5.473,8.462-10.036,1.859-3.9,2.272-6.751,2.634-11.053a17.891,17.891,0,0,0-2.445-10.2l-.14-.247-.071-.268c-.322-1.217.441-5.107.62-5.822,1.444-.106,2.993-.129,3.05-.2.035-.044,1.343-5.134.388-5.1-1.043.036-11.649.345-11.851.519a22.584,22.584,0,0,0-.963,4.461,28.34,28.34,0,0,0,3.649.465c-.095,1.193-.235,3.172-1.085,4.211-.186.228-.566.595-.687.735-5.463,4.39-3.876,11.93-7.82,17.723-3.065,4.5-5.8,6.384-11.207,7.021a26.173,26.173,0,0,0-5.777,1.507c-1.7.655-2.854,1.5-3.034,3.311-.266,2.662,2.4,4.682,4.937,5.533,3.874,1.3,8.963.906,13,.286A22.484,22.484,0,0,0,66.878,175.293Z">
                            </path>
                            <path class="d"
                                d="M152.275,101.1a5.619,5.619,0,0,1-3.621-4.779c0-1.277-.149-20.107-.149-22.048a10.943,10.943,0,0,1,2.322-6.149c-.346-1.263-.287-2.5.759-2.5,1.24,0,13.328-.009,15.337-.009.523,0,1.092.21,1.092,1.319v1.635l.149.126c1.345,1.145,1.987,4.629,1.987,5.7,0,1.462.032,19.969.032,21.022,0,2.851-1.176,5.432-2.732,5.432Z">
                            </path>
                            <path class="d"
                                d="M186.275,101.1a5.619,5.619,0,0,1-3.621-4.779c0-1.277-.149-20.107-.149-22.048a10.943,10.943,0,0,1,2.322-6.149c-.346-1.263-.287-2.5.759-2.5,1.24,0,13.328-.009,15.337-.009.523,0,1.092.21,1.092,1.319v1.635l.149.126c1.345,1.145,1.987,4.629,1.987,5.7,0,1.462.032,19.969.032,21.022,0,2.851-1.176,5.432-2.732,5.432Z">
                            </path>
                            <path class="d"
                                d="M219.275,101.1a5.619,5.619,0,0,1-3.621-4.779c0-1.277-.149-20.107-.149-22.048a10.943,10.943,0,0,1,2.322-6.149c-.346-1.263-.287-2.5.759-2.5,1.24,0,13.328-.009,15.337-.009.523,0,1.092.21,1.092,1.319v1.635l.149.126c1.345,1.145,1.987,4.629,1.987,5.7,0,1.462.032,19.969.032,21.022,0,2.851-1.176,5.432-2.732,5.432Z">
                            </path>
                            <path class="e"
                                d="M165.191,239.593c-2.148-1.7-4.568-2.943-11-1.857a20.558,20.558,0,0,0-9.215,3.739,12.079,12.079,0,0,0-3.913,7.42,15.166,15.166,0,0,0,3.17,10.32c2.368,2.6,15.627,1.637,20.59,1.637">
                            </path>
                            <path class="b"
                                d="M73.017,238.829c-1.7-.94-3.468-2.179-9.9-1.093a20.558,20.558,0,0,0-9.215,3.739,12.079,12.079,0,0,0-3.913,7.42,14.822,14.822,0,0,0,3.17,10.32c2.9,3.017,14.684,1.558,19.608,1.229">
                            </path>
                            <path class="c"
                                d="M119.874,260c0-1.063-.036-12.187-.057-20.388-1-1.863-5.218-3.168-5.218-3.168a18.284,18.284,0,0,0-14.556,0c-2.438,1.042-9.277,4.334-11.833,12.334a15.732,15.732,0,0,0-.278,2.722c-.051,4.747-.074,6.856-.075,8.611Z">
                            </path>
                            <path class="f"
                                d="M41.268,100.405a12.981,12.981,0,0,0,2.5.25h9.693a8.746,8.746,0,0,0,4.769-1.136c1.345-1.009,1.276-2.741,1.276-5.231,0-10.409-.191-18.61-.287-28.958-.009-1.035-1.179-3.252-1.507-4.219-5.828.006-13.288.107-18.334.111-.36,1.07-1.361,3.3-1.371,4.446-.1,10.19-.284,18.324-.284,28.62A10.207,10.207,0,0,0,38.488,99,4.22,4.22,0,0,0,41.268,100.405Z">
                            </path>
                            <path class="g"
                                d="M37.941,70.18c-.077,4.8-.18,6.223-.211,11.56,6.958-.224,14.816-.082,21.766.1-.03-5.43-.132-6.934-.214-11.669Z">
                            </path>
                            <path class="f"
                            ...
                            <path class="g"
                                d="M70.607,70.18c-.077,4.8-.179,6.223-.21,11.56,6.958-.224,14.815-.082,21.765.1-.03-5.43-.132-6.934-.213-11.669Z">
                            </path>
                            <path class="b"
                                d="M214.942,181.454c-1.309-.008-2.747-.017-4.332-.025-1.039-1.631-1.9-2.985-1.9-2.985a6.687,6.687,0,0,1-4.876-4.335c-1.068-4.2-.4-7.285.763-9.109.967-1.516,2.335-4.333,7.126-4.558,2.045-.1,11.61.6,13.889,3.444a2.231,2.231,0,0,1,.32.392c.105,5.455.192,12.2.256,17.26C223.863,181.517,220.614,181.488,214.942,181.454Z">
                            </path>
                            <path class="h"
                                d="M46.376,239.007c.812-1.725,3.626-3.866,6.954-4.123a10.022,10.022,0,0,1,7.763,3.121c-1.421,2.148-3.917,4.735-7.64,4.941A7.814,7.814,0,0,1,46.376,239.007Z">
                            </path>
                            <path class="h"
                                d="M139.8,245.235c-.4-1.863.531-5.274,3.019-7.5a10.019,10.019,0,0,1,8.062-2.236c.176,2.569-.235,6.14-3.067,8.565A7.812,7.812,0,0,1,139.8,245.235Z">
                            </path>
                            <path class="i"
                                d="M118.941,236.458a23.015,23.015,0,0,0-15.309-2.887c-4.534.631-8.964,2.3-11.649,6.2-1.464,2.126,2,4.128,3.454,2.019,1.982-2.879,5.8-3.926,9.1-4.334a19.014,19.014,0,0,1,12.387,2.459c2.2,1.348,4.213-2.11,2.018-3.454Z">
                            </path>
                            <path class="i"
                                d="M111.291,244.471c-.66,1.82-1.327,3.637-1.986,5.456a2.017,2.017,0,0,0,.2,1.541,2,2,0,0,0,2.736.718,2.247,2.247,0,0,0,.919-1.195q.99-2.73,1.986-5.457a2,2,0,0,0-2.938-2.258,2.238,2.238,0,0,0-.919,1.195Z">
                            </path>
                            <path class="i"
                                d="M102,244.724l1.148,3.876a2.09,2.09,0,0,0,.919,1.195,2.044,2.044,0,0,0,1.541.2,2.022,2.022,0,0,0,1.2-.92,2.052,2.052,0,0,0,.2-1.541l-1.148-3.875a2.082,2.082,0,0,0-.919-1.195A2,2,0,0,0,102,244.724Z">
                            </path>
                            <path class="i"
                                d="M102.7,252.225c-2.172-1.114-4.315-2.285-6.488-3.4a2,2,0,0,0-2.019,3.453c2.173,1.115,4.316,2.286,6.488,3.4a2,2,0,1,0,2.019-3.454Z">
                            </path>
                            <path class="i"
                                d="M263.123,29.778q.014,30.4.03,60.794.018,35.494.037,70.988.017,34.638.035,69.276.013,28.411.028,56.822.006,16.188.012,32.377v1.742l2-2c-3.766.006-7.532-.008-11.3-.019q-10.081-.029-20.163-.067-13.527-.049-27.054-.1-15.775-.065-31.551-.131-17.089-.07-34.18-.145l-34.348-.146q-16.338-.07-32.675-.138l-28.553-.117q-11.27-.043-22.539-.084-7.083-.024-14.167-.04l-1.979,0,2,2c0-9.664-.055-19.329-.094-28.994q-.109-27.085-.236-54.17-.156-34.067-.317-68.133L7.776,98.673q-.147-31.256-.292-62.511l-.03-6.384c-.011-2.573-4.011-2.578-4,0q.139,30.347.284,60.693l.333,70.374q.163,34.529.323,69.056.129,28.228.249,56.457.067,16.335.114,32.669,0,.879,0,1.756a2.028,2.028,0,0,0,2,2q5.942,0,11.882.028,10.31.033,20.619.074l27.386.11,31.755.134,34.26.146,34.3.146,32.5.135q14.127.059,28.254.112,11.055.042,22.11.078,6.809.021,13.616.032h1.824a2.03,2.03,0,0,0,2-2q0-14.365-.01-28.732-.012-27.255-.026-54.512-.018-34.174-.035-68.349-.018-35.717-.037-71.434-.015-31.236-.031-62.473l0-6.5c0-2.574-4-2.578-4,0Z">
                            </path>
                            <path class="i"
                                d="M7.265,28.778c0-8.927.259-17.852.267-26.778l-2,2c2.923,0,5.846.015,8.768.025q9.576.033,19.151.069l27.06.1,32.5.124,35.46.137,35.951.138,33.969.128q14.755.056,29.513.109,11.292.04,22.585.078,6.592.021,13.185.037l1.5,0-2-2q0,12.914.019,25.828c0,2.574,4,2.578,4,0q0-12.913-.019-25.828a2.029,2.029,0,0,0-2-2c-3.511,0-7.022-.015-10.533-.026Q244.373.893,234.105.855l-28.061-.1L172.929.628l-35.7-.136L101.426.354,67.984.225q-14.3-.054-28.6-.108Q28.732.076,18.084.039,12.327.018,6.571,0L5.532,0a2.029,2.029,0,0,0-2,2c-.008,8.926-.264,17.851-.267,26.778,0,2.574,4,2.578,4,0Z">
                            </path>
                            <path class="i"
                                d="M248.659,30.333q0,5,0,10,0,9.227.011,18.453l.018,24.746.021,29.221q.012,15.781.023,31.564l.024,31.735q.011,15.072.022,30.145l.018,26.281q.008,10.3.013,20.608,0,6.389.007,12.777v1.69c0,2.573,4,2.578,4,0q0-5.286,0-10.571l-.012-18.9-.018-25.066-.021-29.42q-.012-15.82-.023-31.64-.012-15.844-.023-31.689-.012-14.988-.022-29.976-.011-12.994-.019-25.99-.006-10.1-.013-20.2,0-6.118-.006-12.239,0-.771,0-1.541c0-2.573-4-2.578-4,0Z">
                            </path>
                            <path class="i"
                                d="M17.659,30.333q0,5,.005,10,0,9.227.011,18.453l.018,24.746.021,29.221q.012,15.781.023,31.564l.024,31.735q.011,15.072.022,30.145l.018,26.281q.008,10.3.013,20.608,0,6.389.007,12.777v1.69c0,2.573,4,2.578,4,0q0-5.286,0-10.571l-.012-18.9-.018-25.066-.021-29.42q-.012-15.82-.023-31.64-.012-15.844-.023-31.689Q21.708,105.286,21.7,90.3q-.011-12.994-.019-25.99-.006-10.1-.013-20.2,0-6.118-.006-12.239,0-.771,0-1.541c0-2.573-4-2.578-4,0Z">
                            </path>
                            <path class="i" d="M19.71,270.625c2.574,0,2.578-4,0-4s-2.578,4,0,4Z"></path>
                            <path class="i"
                                d="M44.376,258.588q-11.592-.018-23.185-.032c-2.574,0-2.578,4,0,4q11.594,0,23.185.032c2.574,0,2.578-4,0-4Z">
                            </path>
                            <path class="i"
                                d="M151.932,258.767q-14.53,0-29.062-.043l-46.423-.082-21.293-.037c-2.574,0-2.578,4,0,4q20.852.034,41.7.073,21.432.037,42.865.073,6.1.01,12.209.016c2.574,0,2.578-4,0-4Z">
                            </path>
                            <path class="i"
                                d="M198.006,258.86q-23.037-.035-46.074-.075c-2.574,0-2.578,4,0,4q23.037.041,46.074.075c2.574,0,2.578-4,0-4Z">
                            </path>
                            <path class="i"
                                d="M249.265,258.926q-11.481,0-22.962-.026c-2.574,0-2.578,4,0,4q11.481.017,22.962.026c2.574,0,2.578-4,0-4Z">
                            </path>
                            <path class="i"
                                d="M80.154,186.842q-26.176-.114-52.354-.2-3.544-.009-7.089-.013c-2.574,0-2.578,4,0,4,13.793,0,27.587.083,41.38.14l18.063.077c2.575.012,2.578-3.988,0-4Z">
                            </path>
                            <path class="i"
                                d="M246.674,187.555c-11.28.018-22.56-.07-33.84-.118q-32.133-.137-64.267-.287l-40.3-.183c-2.574-.011-2.578,3.988,0,4q35.424.159,70.847.322,26.942.122,53.882.23c4.56.016,9.119.043,13.679.036,2.573,0,2.578-4,0-4Z">
                            </path>
                            <path class="i"
                                d="M79.933,178.84q-25.521-.111-51.042-.2-3.2-.009-6.4-.013c-2.574,0-2.579,4,0,4,13.168,0,26.337.083,39.506.138l17.939.077c2.574.011,2.577-3.989,0-4Z">
                            </path>
                            <path class="i"
                                d="M127.266,179.052q-9.111-.042-18.222-.087c-2.574-.012-2.577,3.988,0,4q9.111.04,18.222.087c2.574.012,2.578-3.988,0-4Z">
                            </path>
                            <path class="i"
                                d="M186.71,179.335q-23.168-.1-46.334-.238c-2.574-.012-2.577,3.988,0,4q23.167.1,46.334.238c2.574.012,2.577-3.988,0-4Z">
                            </path>
                            <path class="i"
                                d="M248.45,179.555c-10.412.016-20.825-.065-31.237-.111l-15.725-.069c-2.575-.011-2.578,3.989,0,4q20.953.091,41.908.174,2.528.006,5.054.006c2.574,0,2.579-4,0-4Z">
                            </path>
                            <path class="i"
                                d="M248.383,107.555c-3.383,0-6.765-.008-10.148-.018q-8.892-.026-17.785-.063-11.731-.047-23.463-.1l-27.522-.122-29.645-.136-29.788-.137-28.375-.129q-12.49-.056-24.98-.109-9.834-.042-19.668-.078-6.351-.024-12.7-.038l-1.819,0c-2.574,0-2.579,4,0,4q5.348,0,10.7.026,9.108.032,18.216.07,11.886.049,23.772.1,13.859.062,27.716.126l29.718.136,29.744.137q14.1.063,28.211.126,12.348.054,24.7.105,9.635.039,19.268.073,6.091.02,12.182.029h1.675c2.573,0,2.578-4,0-4Z">
                            </path>
                            <path class="i"
                                d="M40.932,98.675q-9.222-.034-18.444-.05c-2.574,0-2.579,4,0,4q9.222,0,18.444.05c2.574.01,2.578-3.99,0-4Z">
                            </path>
                            <path class="i"
                                d="M110.377,98.97q-22.042-.114-44.085-.247Q60.946,98.7,55.6,98.675c-2.575-.009-2.578,3.991,0,4q20.059.076,40.118.215,7.331.042,14.66.08c2.575.013,2.578-3.987,0-4Z">
                            </path>
                            <path class="i"
                                d="M152.451,99.176q-6.815-.03-13.629-.064a2,2,0,0,0,0,4q6.815.033,13.629.064a2,2,0,0,0,0-4Z">
                            </path>
                            <path class="i"
                                d="M186.275,99.288q-9.246-.043-18.491-.081c-2.574-.011-2.578,3.989,0,4q9.245.044,18.491.081c2.574.013,2.577-3.987,0-4Z">
                            </path>
                            <path class="i"
                                d="M201.6,103.207c13.628.058,27.257.024,40.886.057q4.056.009,8.114.024c2.574.013,2.577-3.987,0-4q-16.887-.078-33.773-.088c-5.076,0-10.152.029-15.227.007-2.575-.01-2.578,3.99,0,4Z">
                            </path>
                            <path class="i"
                                d="M270.376,27.555c-3.86,0-7.721-.008-11.582-.018q-10.414-.026-20.831-.063-14.076-.046-28.151-.1l-32.907-.122L141.4,27.119l-35.845-.138-33.926-.128Q56.7,26.8,41.77,26.743q-11.64-.042-23.279-.079-7.287-.023-14.575-.037l-1.984,0c-2.574,0-2.578,4,0,4q6.084,0,12.168.026,10.643.032,21.286.07,14.243.05,28.483.1l33.112.125,35.584.136,35.8.137,33.753.126q14.778.054,29.556.105,11.427.039,22.853.073,7.011.02,14.022.029.913,0,1.829,0c2.574,0,2.579-4,0-4Z">
                            </path>
                            <path class="i"
                                d="M270.376,267.555c-3.86,0-7.721-.008-11.582-.018q-10.414-.026-20.831-.063-14.076-.046-28.151-.1l-32.907-.122-35.506-.135-35.845-.138-33.926-.128q-14.93-.057-29.858-.11-11.64-.042-23.279-.079-7.287-.022-14.575-.037l-1.984,0c-2.574,0-2.578,4,0,4q6.084,0,12.168.026,10.643.031,21.286.07,14.243.05,28.483.1l33.112.125,35.584.136,35.8.137,33.753.126q14.778.054,29.556.1,11.427.039,22.853.073,7.011.019,14.022.029h1.829c2.574,0,2.579-4,0-4Z">
                            </path>
                            <path class="i"
                            ...
                            <path class="i"
                                d="M51.612,55.2c.869,1.236,1.778,2.442,2.651,3.674,1.046,1.479,2.231,2.819,2.7,4.607.553,2.088.276,4.489.3,6.637q.041,3.4.089,6.794c.061,4.5.118,9.009.137,13.513a40.239,40.239,0,0,1-.059,6.561,1.975,1.975,0,0,1-1.948,1.674c-2.572.044-2.58,4.044,0,4a6.03,6.03,0,0,0,5.928-5.513A48.374,48.374,0,0,0,61.5,91.61q-.01-3.129-.04-6.257c-.037-3.934-.095-7.869-.147-11.8q-.041-3.016-.074-6.034a17.815,17.815,0,0,0-.651-5.867c-1.1-3.12-3.633-5.785-5.522-8.473-1.468-2.091-4.938-.094-3.454,2.019Z">
                            </path>
                            <path class="i"
                                d="M44.73,51.269a1.407,1.407,0,0,1-.325-.012c.039.036.4.1.133.015-.5-.154.249.167.018.023.437.272.343.288.232.171.345.362.285.4.2.247.244.435.185.482.134.288-.056-.214.059.609.052.349-.009-.345-.044.219-.055.309.025-.209.071-.417.086-.626.029-.387,0-.785,0-1.173q0-2.271.009-4.542c0-.082,0-.164,0-.247,0-.252.136-.323-.04.189a1.429,1.429,0,0,0,.079-.326c-.006-.014-.209.517-.1.229.027-.069.2-.341,0-.031-.234.378.172-.13-.144.156-.346.313.225-.117-.159.1l-.133.058c.164-.038.159-.042-.013-.015.008.028-.368,0,.03.012.136,0,.273,0,.41,0h6.493c.111,0,.224,0,.335,0,.14-.005.36.069-.117-.029.156.032.264.139-.146-.085.133.072.237.184-.146-.141.063.053.274.283.033.01-.222-.253-.061-.057-.015.029-.014-.025-.141-.493-.111-.24a.9.9,0,0,0,.04.153c.055.15-.083.386-.038-.324-.018.3.013.607.013.9q0,2.466.005,4.932c0,.163-.015.335,0,.5.013.185.149-.629.012-.212-.068.206.234-.477.118-.285s.368-.392.15-.185.193-.149.191-.148c-.255.171.157-.1.185-.073-.01-.009-.231.08-.247.058s.435-.019.076-.036c-.13-.006-.263,0-.393,0H44.73a2,2,0,0,0,0,4h6.917a4.492,4.492,0,0,0,2.42-.547,3.158,3.158,0,0,0,1.433-2.64c.063-1.7,0-3.419-.005-5.122a5.818,5.818,0,0,0-.415-2.671,3.394,3.394,0,0,0-2.95-1.84c-1.08-.061-2.178,0-3.259,0H45.123a4.121,4.121,0,0,0-2.329.544,3.659,3.659,0,0,0-1.568,2.924c-.119,1.772-.021,3.584-.017,5.359a4.784,4.784,0,0,0,0,.738c-.036-.22.089-.654.06-.449s-.066.4-.083.606a2.872,2.872,0,0,0,.122,1.034c.44,1.5,2,2.044,3.421,2.069a2,2,0,0,0,0-4Z">
                            </path>
                            <path class="i"
                                d="M38.561,72.182c6.76,0,13.52-.022,20.28-.022,2.574,0,2.578-4,0-4-6.76,0-13.52.022-20.28.022-2.574,0-2.578,4,0,4Z">
                            </path>
                            <path class="i"
                                d="M38.057,83.73c7.024-.207,14.054-.079,21.078.1,2.575.066,2.573-3.934,0-4-7.024-.18-14.054-.308-21.078-.1-2.569.076-2.58,4.076,0,4Z">
                            </path>
                            <path class="i"
                                d="M84.279,55.2c.835,1.188,1.707,2.349,2.549,3.532a18.937,18.937,0,0,1,2.521,3.853c.739,1.881.545,3.942.567,5.921q.036,3.218.079,6.433c.055,4.308.112,8.617.145,12.926q.025,3.261.03,6.522c0,.995.029,2-.019,2.99A3.229,3.229,0,0,1,89.9,98.8c-.653,1.014-2.9.929-3.929.937-1.136.008-2.272,0-3.408,0a61.61,61.61,0,0,1-7.481-.075,6.42,6.42,0,0,1-1.9-.466c-.411-.194-.394-.276-.525-.767a22.445,22.445,0,0,1-.263-5.775q.021-6.56.114-13.117.045-3.666.093-7.331c.03-2.372-.084-4.792.1-7.157a10.281,10.281,0,0,1,2.367-5.381c1.139-1.549,2.259-3.13,3.262-4.771,1.346-2.2-2.113-4.214-3.454-2.019-2.034,3.328-5.111,6.287-5.913,10.217a36.958,36.958,0,0,0-.334,6.954q-.042,3.686-.092,7.369c-.062,4.834-.12,9.668-.138,14.5-.013,3.369-.831,8.935,2.857,10.771,2.725,1.357,6,1.045,8.955,1.045,3.027,0,6.349.344,9.311-.387a5.63,5.63,0,0,0,4.163-3.3c.709-1.828.492-4,.489-5.917-.007-4.838-.056-9.675-.115-14.512q-.049-4-.1-8.006a59.186,59.186,0,0,0-.227-8.027c-.61-4.031-3.724-7.186-5.993-10.416-1.469-2.091-4.938-.094-3.454,2.019Z">
                            </path>
                            <path class="i"
                                d="M77.4,51.269a1.4,1.4,0,0,1-.324-.012c.039.036.4.1.133.015-.5-.154.248.167.018.023.436.272.343.288.232.171.344.362.285.4.2.247.244.435.186.482.135.288-.057-.214.058.609.051.349-.009-.345-.043.219-.054.309.025-.209.07-.417.086-.626.028-.387,0-.785,0-1.173q0-2.271.008-4.542c0-.082,0-.164,0-.247,0-.252.137-.323-.04.189a1.434,1.434,0,0,0,.08-.326c-.007-.014-.21.517-.1.229.027-.069.194-.341,0-.031-.234.378.172-.13-.144.156-.346.313.224-.117-.16.1l-.132.058c.163-.038.159-.042-.013-.015.007.028-.369,0,.03.012.136,0,.273,0,.409,0h6.494c.111,0,.223,0,.335,0,.14-.005.359.069-.117-.029.155.032.263.139-.146-.085.133.072.236.184-.147-.141.063.053.275.283.034.01-.223-.253-.061-.057-.016.029-.013-.025-.14-.493-.11-.24a.9.9,0,0,0,.039.153c.056.15-.082.386-.037-.324-.019.3.013.607.013.9q0,2.466,0,4.932c0,.163-.016.335,0,.5.014.185.15-.629.013-.212-.068.206.234-.477.118-.285s.368-.392.149-.185.193-.149.192-.148c-.255.171.157-.1.184-.073-.009-.009-.23.08-.246.058s.434-.019.076-.036c-.131-.006-.263,0-.393,0H77.4a2,2,0,0,0,0,4h6.918a4.486,4.486,0,0,0,2.419-.547,3.153,3.153,0,0,0,1.433-2.64c.064-1.7,0-3.419,0-5.122a5.819,5.819,0,0,0-.416-2.671,3.391,3.391,0,0,0-2.949-1.84c-1.08-.061-2.178,0-3.259,0H77.789a4.123,4.123,0,0,0-2.329.544,3.66,3.66,0,0,0-1.567,2.924c-.119,1.772-.021,3.584-.017,5.359a4.784,4.784,0,0,0,0,.738c-.037-.22.088-.654.059-.449s-.065.4-.082.606a2.871,2.871,0,0,0,.121,1.034c.44,1.5,2,2.044,3.421,2.069a2,2,0,0,0,0-4Z">
                            </path>
                            <path class="i"
                                d="M71.228,72.182c6.76,0,13.52-.022,20.28-.022,2.574,0,2.578-4,0-4-6.76,0-13.52.022-20.28.022-2.574,0-2.579,4,0,4Z">
                            </path>
                            <path class="i"
                                d="M77.572,63.071c2.314,0,4.628-.022,6.942-.022a2,2,0,0,0,0-4c-2.314,0-4.628.022-6.942.022a2,2,0,0,0,0,4Z">
                            </path>
                            <path class="i"
                                d="M70.723,83.73c7.025-.207,14.055-.079,21.079.1,2.575.066,2.573-3.934,0-4-7.024-.18-14.054-.308-21.079-.1-2.568.076-2.579,4.076,0,4Z">
                            </path>
                            <path class="i"
                                d="M178.488,137.111q0,18.481-.008,36.963,0,3.06,0,6.121c0,2.574,4,2.578,4,0q0-17.7.008-35.411,0-3.835,0-7.673c0-2.574-4-2.578-4,0Z">
                            </path>
                            <path class="i"
                                d="M219.265,143.222c-10.59-.2-21.186-.148-31.777-.148-2.574,0-2.579,4,0,4,10.591,0,21.187-.047,31.777.148,2.575.048,2.575-3.952,0-4Z">
                            </path>
                            <path class="i"
                                d="M197.932,152.549c-4,0-8-.139-12-.142a2,2,0,0,0,0,4c4,0,8,.139,12,.142a2,2,0,0,0,0-4Z">
                            </path>
                            <path class="i"
                                d="M194.525,154.677c-2.593,0-5.185-.139-7.778-.141a2,2,0,0,0,0,4c2.593,0,5.185.138,7.778.141a2,2,0,0,0,0-4Z">
                            </path>
                            <path class="i"
                                d="M140.3,153.438c-4,0-8-.139-12-.142a2,2,0,1,0,0,4c4,0,8,.139,12,.142a2,2,0,1,0,0-4Z">
                            </path>
                            <path class="i"
                                d="M137.117,155.788c-2.593,0-5.185-.139-7.778-.141a2,2,0,0,0,0,4c2.593,0,5.185.138,7.778.141a2,2,0,0,0,0-4Z">
                            </path>
                            <path class="i"
                                d="M180.9,139.111c12.736,0,25.472.109,38.208.163,2.128.009,4.256.022,6.385.022l-2-2c.014,10.62.33,21.244.566,31.86.084,3.75.172,7.5.174,11.251,0,2.574,4,2.579,4,0-.008-11.555-.448-23.117-.626-34.671-.043-2.813-.111-5.627-.114-8.44a2.031,2.031,0,0,0-2-2c-12.635,0-25.27-.11-37.9-.162-2.229-.009-4.459-.022-6.688-.023-2.574,0-2.578,4,0,4Z">
                            </path>
                            <path class="i"
                                d="M118.488,137c0,12.333.079,24.667.121,37,.007,2.065.017,4.13.018,6.195,0,2.574,4,2.578,4,0,0-11.813-.086-23.627-.122-35.44q-.012-3.877-.017-7.755c0-2.574-4-2.578-4,0Z">
                            </path>
                            <path class="i"
                                d="M158.821,143.222c-10.59-.181-21.187-.3-31.778-.148-2.572.038-2.579,4.038,0,4,10.591-.156,21.188-.033,31.778.148,2.575.044,2.575-3.956,0-4Z">
                            </path>
                            <path class="i"
                                d="M121.5,138.727c-.286.162-1.371.237-.6.242.335,0,.671-.014,1.006-.018,1.067-.01,2.135-.009,3.2-.007,3.381.007,6.762.033,10.143.061q11.724.095,23.448.229c2.312.024,4.625.061,6.937.062l-2-2c.014,10.62.331,21.244.567,31.86.083,3.75.171,7.5.173,11.251,0,2.574,4,2.579,4,0-.008-11.555-.448-23.117-.626-34.671-.043-2.813-.11-5.627-.114-8.44a2.03,2.03,0,0,0-2-2c-13.4-.008-26.795-.319-40.193-.351-1.211,0-2.423-.006-3.634.007a4.878,4.878,0,0,0-2.331.321c-2.239,1.269-.226,4.726,2.019,3.454Z">
                            </path>
                            <path class="i"
                                d="M167.784,102.852c5.787-.479,4.73-9.049,4.723-13.184q-.012-7.248-.022-14.5c0-2.657-.561-5.98-2.575-7.885-1.869-1.768-4.7,1.055-2.828,2.828,1.231,1.165,1.4,3.414,1.4,4.9q0,2.586.008,5.173l.021,13.44c0,.566.007,1.133,0,1.7a8.132,8.132,0,0,1-.275,2.178,5.03,5.03,0,0,1-.468,1.117c-.2.365-.462.273.012.234-2.547.211-2.57,4.213,0,4Z">
                            </path>
                            <path class="i"
                                d="M148.85,67.921c-2.67,4.333-2,9.415-1.962,14.271.032,4.52.073,9.04.1,13.56a7.737,7.737,0,0,0,4.614,7.077c2.314,1.1,4.347-2.351,2.019-3.453a4.362,4.362,0,0,1-2.555-2.585c-.143-.461-.068-.211-.075-.6,0-.2,0-.393,0-.589q-.015-2.6-.036-5.207-.051-6.933-.1-13.866c0-.686-.016-1.373-.011-2.059A8.818,8.818,0,0,1,152.3,69.94c1.354-2.2-2.1-4.209-3.454-2.019Z">
                            </path>
                            <path class="i"
                                d="M152.969,66.891c-.021.5-1.573.66-.862.739a5.025,5.025,0,0,0,.535,0h1.725l5.128,0,5.131,0h1.852a5.292,5.292,0,0,0,.617,0c.258-.032.095.12-.085-.046.422.388-.649-.371-.662-.635a2.042,2.042,0,0,0,2,2,2.02,2.02,0,0,0,2-2,3.173,3.173,0,0,0-2.205-3.2,6.781,6.781,0,0,0-1.665-.114l-4.093,0-9.275.006c-.389,0-.783-.019-1.172,0a3.076,3.076,0,0,0-2.969,3.261,2,2,0,1,0,4,0Z">
                            </path>
                            <path class="i"
                                d="M150.419,79.023c6.259,0,12.518-.106,18.777-.109,2.574,0,2.578-4,0-4-6.259,0-12.518.105-18.777.109-2.574,0-2.579,4,0,4Z">
                            </path>
                            <path class="i"
                                d="M155.167,94.806c3.094,0,6.187-.052,9.28-.053a2,2,0,0,0,0-4c-3.093,0-6.186.051-9.28.053a2,2,0,0,0,0,4Z">
                            </path>
                            <path class="i"
                                d="M201.451,102.852c5.788-.479,4.73-9.049,4.723-13.184q-.011-7.248-.022-14.5c0-2.657-.56-5.98-2.574-7.885-1.87-1.768-4.7,1.055-2.828,2.828,1.23,1.165,1.4,3.414,1.4,4.9q0,2.586.007,5.173.011,6.72.022,13.44c0,.566.006,1.133,0,1.7a8.133,8.133,0,0,1-.276,2.178,4.981,4.981,0,0,1-.467,1.117c-.2.365-.462.273.011.234-2.547.211-2.569,4.213,0,4Z">
                            </path>
                            <path class="i"
                                d="M182.517,67.921c-2.669,4.333-2,9.415-1.962,14.271.033,4.52.073,9.04.1,13.56a7.737,7.737,0,0,0,4.613,7.077c2.315,1.1,4.347-2.351,2.019-3.453a4.361,4.361,0,0,1-2.554-2.585c-.144-.461-.068-.211-.076-.6,0-.2,0-.393,0-.589q-.015-2.6-.036-5.207-.05-6.933-.1-13.866c0-.686-.016-1.373-.011-2.059a8.818,8.818,0,0,1,1.466-4.525c1.354-2.2-2.1-4.209-3.454-2.019Z">
                            </path>
                            <path class="i"
                                d="M186.636,66.891c-.02.5-1.573.66-.862.739a5.025,5.025,0,0,0,.535,0h1.725l5.128,0,5.132,0h1.851a5.292,5.292,0,0,0,.617,0c.258-.032.1.12-.084-.046.421.388-.65-.371-.663-.635a2.043,2.043,0,0,0,2,2,2.019,2.019,0,0,0,2-2,3.173,3.173,0,0,0-2.2-3.2,6.786,6.786,0,0,0-1.666-.114l-4.092,0-9.275.006c-.389,0-.784-.019-1.172,0a3.076,3.076,0,0,0-2.97,3.261,2,2,0,0,0,4,0Z">
                            </path>
                            <path class="i"
                                d="M184.086,79.023c6.259,0,12.518-.106,18.778-.109,2.573,0,2.578-4,0-4-6.26,0-12.519.105-18.778.109-2.574,0-2.578,4,0,4Z">
                            </path>
                            <path class="i"
                                d="M188.835,94.806c3.093,0,6.186-.052,9.28-.053a2,2,0,0,0,0-4c-3.094,0-6.187.051-9.28.053a2,2,0,0,0,0,4Z">
                            </path>
                            <path class="i"
                                d="M233.75,70.115c1.1,1.038,1.384,3.225,1.4,4.494.015,1.144,0,2.289,0,3.433l.018,11.772q0,2.454.007,4.908a14.092,14.092,0,0,1-.223,3.56,13.692,13.692,0,0,1-.645,1.484c-.151.4-.283.092.138.049-.015,0-.032,0-.047,0-.341.025-.69.007-1.031.01l-4.791.047-9.307.091,1.009.273a4.277,4.277,0,0,1-2.581-2.694c-.1-.388-.042-.111-.049-.518,0-.212,0-.425,0-.637q-.015-2.739-.037-5.48-.05-7.159-.1-14.32c0-.686-.014-1.371-.01-2.057a8.86,8.86,0,0,1,1.465-4.59c1.354-2.2-2.1-4.209-3.454-2.019a12.853,12.853,0,0,0-2.011,6.609c-.006,1,.01,1.99.016,2.984q.033,5.1.07,10.2.03,4.336.059,8.672a8.056,8.056,0,0,0,.469,3.018c.785,1.975,2.9,4.421,5.176,4.558,2.294.138,4.653-.046,6.949-.068,2.649-.026,5.309.017,7.956-.078,3.978-.143,4.976-4.642,4.981-7.9.005-2.711-.007-5.423-.011-8.134q-.009-5.537-.017-11.071c0-3.2-.083-7.07-2.576-9.428-1.87-1.768-4.7,1.055-2.828,2.828Z">
                            </path>
                            <path class="i"
                                d="M219.636,66.891c-.02.5-1.573.66-.862.739a5.025,5.025,0,0,0,.535,0h1.725l5.128,0,5.132,0h1.851a5.292,5.292,0,0,0,.617,0c.258-.032.1.12-.084-.046.421.388-.65-.371-.663-.635a2.043,2.043,0,0,0,2,2,2.019,2.019,0,0,0,2-2,3.173,3.173,0,0,0-2.2-3.2,6.786,6.786,0,0,0-1.666-.114l-4.092,0-9.275.006c-.389,0-.784-.019-1.172,0a3.076,3.076,0,0,0-2.97,3.261,2,2,0,0,0,4,0Z">
                            </path>
                            <path class="i"
                                d="M217.086,79.023c6.259,0,12.518-.106,18.778-.109,2.573,0,2.578-4,0-4-6.26,0-12.519.105-18.778.109-2.574,0-2.578,4,0,4Z">
                            </path>
                            <path class="i"
                                d="M221.84,94.806c3.09,0,6.18-.052,9.27-.053a2,2,0,0,0,0-4c-3.09,0-6.18.051-9.27.053a2,2,0,0,0,0,4Z">
                            </path>
                            <path class="i"
                                d="M227.026,162.472c-1.809-2.138-5.169-2.846-7.787-3.318a35.225,35.225,0,0,0-7.469-.714,9.954,9.954,0,0,0-8.228,4.487,12.938,12.938,0,0,0-2.118,9.053,10.019,10.019,0,0,0,1.66,4.962,8.511,8.511,0,0,0,5.094,3.431c2.512.527,3.585-3.328,1.063-3.857a4.872,4.872,0,0,1-2.772-1.683,6.066,6.066,0,0,1-.449-.692c-.046-.08-.3-.615-.2-.355s-.041-.128-.061-.209c-.132-.518-.249-1.042-.33-1.57a9.259,9.259,0,0,1,1.423-6.846c.111-.172.224-.342.342-.509.173-.243-.06.041.214-.268a5.687,5.687,0,0,1,1.042-.962,6.473,6.473,0,0,1,3.414-.985,30.865,30.865,0,0,1,5.8.486,26.429,26.429,0,0,1,4.07.963,6.68,6.68,0,0,1,1.462.621,5.277,5.277,0,0,1,.654.411c-.274-.21.267.289.346.383a2.016,2.016,0,0,0,2.828,0,2.043,2.043,0,0,0,0-2.829Z">
                            </path>
                            <path class="i"
                                d="M213.339,170.118a.965.965,0,0,1,.111-.185l-.312.405a1.369,1.369,0,0,1,.165-.158l-.4.313a1.8,1.8,0,0,1,.327-.188l-.478.2a2.929,2.929,0,0,1,.736-.194l-.531.071a3.015,3.015,0,0,1,.723,0l-.532-.071c.615.1,1.166.425,1.773.555a5.625,5.625,0,0,0,2.879-.206,2.1,2.1,0,0,0,1.2-.919,2,2,0,0,0-2.259-2.938,6.642,6.642,0,0,1-1.013.244l.532-.072a2.765,2.765,0,0,1-.61,0l.531.071a10.525,10.525,0,0,1-1.513-.475,4.114,4.114,0,0,0-1.534-.2,5.166,5.166,0,0,0-1.919.485,2.79,2.79,0,0,0-1.322,1.248,2.168,2.168,0,0,0-.2,1.541,2.046,2.046,0,0,0,.919,1.2,2.02,2.02,0,0,0,1.542.2,1.952,1.952,0,0,0,1.195-.919Z">
                            </path>
                            <path class="i"
                                d="M39.2,214.88c-.147,13.062-.133,26.128-.148,39.191q0,2.657-.005,5.313c0,2.574,4,2.578,4,0q0-17.337.082-34.675c.016-3.276.034-6.553.071-9.829.029-2.575-3.971-2.577-4,0Z">
                            </path>
                            <path class="i"
                                d="M74.992,215.019c0-2.692.064-5.383.068-8.075a2.029,2.029,0,0,0-2-2c-10.558,0-21.116-.1-31.675-.1a2.03,2.03,0,0,0-2,2c-.016,2.707-.182,5.412-.189,8.12-.007,2.574,3.993,2.578,4,0,.007-2.708.173-5.413.189-8.12l-2,2c10.559,0,21.117.1,31.675.1l-2-2c0,2.692-.066,5.383-.068,8.075,0,2.574,4,2.578,4,0Z">
                            </path>
                            <path class="i"
                                d="M75.06,260q0-18.562-.06-37.126-.006-3.927-.008-7.855c0-2.574-4-2.578-4,0q0,19.76.06,39.519,0,2.73.008,5.462c0,2.574,4,2.578,4,0Z">
                            </path>
                            <path class="i"
                                d="M41.421,216.95c10.281,0,20.563-.1,30.844-.1,2.574,0,2.578-4,0-4-10.281,0-20.563.1-30.844.1-2.574,0-2.578,4,0,4Z">
                            </path>
                            <path class="i"
                                d="M45.109,63.071c2.314,0,4.628-.022,6.942-.022a2,2,0,0,0,0-4c-2.314,0-4.628.022-6.942.022a2,2,0,0,0,0,4Z">
                            </path>
                            <path class="i"
                                d="M121.806,215.019c0-2.692.064-5.383.069-8.075a2.029,2.029,0,0,0-2-2c-10.558,0-21.117-.1-31.675-.1a2.029,2.029,0,0,0-2,2c-.016,2.707-.182,5.412-.189,8.12-.008,2.574,3.992,2.578,4,0,.007-2.708.173-5.413.189-8.12l-2,2c10.558,0,21.117.1,31.675.1l-2-2c0,2.692-.066,5.383-.069,8.075,0,2.574,4,2.578,4,0Z">
                            </path>
                            <path class="i"
                                d="M117.806,216.8q0,19.76.06,39.518,0,2.732.009,5.463l2-2-28.043-.162-3.974-.023,2,2q0-18.287.082-36.574.023-5.07.071-10.139c.029-2.575-3.971-2.577-4,0-.155,13.7-.134,27.4-.149,41.1q0,2.806,0,5.615a2.031,2.031,0,0,0,2,2l28.043.162,3.974.023a2.029,2.029,0,0,0,2-2c0-12.375-.043-24.751-.06-37.126q-.006-3.927-.009-7.855c0-2.574-4-2.578-4,0Z">
                            </path>
                            <path class="i"
                                d="M88.236,216.95c10.281,0,20.563-.1,30.844-.1,2.574,0,2.578-4,0-4-10.281,0-20.563.1-30.844.1-2.574,0-2.578,4,0,4Z">
                            </path>
                            <path class="i"
                                d="M95.784,225.9c5.877,0,11.754-.12,17.631-.122,2.574,0,2.578-4,0-4-5.877,0-11.754.119-17.631.122-2.574,0-2.578,4,0,4Z">
                            </path>
                            <path class="i"
                                d="M95.819,227.819c4.7,0,9.409-.107,14.113-.109a2,2,0,0,0,0-4c-4.7,0-9.408.107-14.113.109a2,2,0,1,0,0,4Z">
                            </path>
                            <path class="i"
                                d="M167.251,215.019c0-2.692.064-5.383.068-8.075a2.028,2.028,0,0,0-2-2c-10.558,0-21.116-.1-31.675-.1a2.03,2.03,0,0,0-2,2c-.016,2.707-.181,5.412-.189,8.12-.007,2.574,3.993,2.578,4,0,.008-2.708.173-5.413.189-8.12l-2,2c10.559,0,21.117.1,31.675.1l-2-2c0,2.692-.065,5.383-.068,8.075,0,2.574,4,2.578,4,0Z">
                            </path>
                            <path class="i"
                                d="M163.251,215.019q0,20.428.06,40.858,0,2.857.008,5.716l2-2-28.042-.13-3.975-.019,2,2q0-18.26.082-36.52c.016-3.348.033-6.7.071-10.044.029-2.575-3.971-2.577-4,0-.154,13.673-.133,27.35-.148,41.024q0,2.77,0,5.54a2.03,2.03,0,0,0,2,2l28.043.13,3.974.019a2.028,2.028,0,0,0,2-2q0-19.229-.06-38.456,0-4.059-.008-8.118c0-2.574-4-2.578-4,0Z">
                            </path>
                            <path class="i"
                                d="M175.719,254.667q0-16.23-.052-32.459-.006-3.494-.008-6.986c0-2.574-4-2.578-4,0q0,17.286.053,34.573,0,2.436.007,4.872c0,2.573,4,2.578,4,0Z">
                            </path>
                            <path class="i"
                                d="M133.68,216.95c10.282,0,20.563-.1,30.845-.1,2.573,0,2.578-4,0-4-10.282,0-20.563.1-30.845.1-2.574,0-2.578,4,0,4Z">
                            </path>
                            <path class="i"
                                d="M141.228,225.9c5.877,0,11.754-.12,17.631-.122,2.574,0,2.578-4,0-4-5.877,0-11.754.119-17.631.122-2.574,0-2.578,4,0,4Z">
                            </path>
                            <path class="i"
                                d="M141.264,227.819c4.667,0,9.334-.107,14-.109a2,2,0,0,0,0-4c-4.667,0-9.334.107-14,.109a2,2,0,0,0,0,4Z">
                            </path>
                            <path class="i"
                                d="M48.9,225.9c5.877,0,11.754-.12,17.631-.122,2.574,0,2.578-4,0-4-5.877,0-11.754.119-17.631.122-2.574,0-2.578,4,0,4Z">
                            </path>
                            <path class="i"
                                d="M48.93,227.819c4.779,0,9.557-.107,14.335-.109a2,2,0,1,0,0-4c-4.778,0-9.556.107-14.335.109a2,2,0,1,0,0,4Z">
                            </path>
                            <path class="i"
                ...
                <ul id="components-nav-2"
                    class="nav-content collapse {{ Request::routeIs('admin.product_categories.*', 'admin.products.*', 'admin.comments.*') ? 'show' : '' }}"
                    data-bs-parent="#sidebar-nav-2">
                    <li>
                        <a href="{{ route('admin.product_categories.index') }}"
                            class="{{ Request::routeIs('admin.product_categories.*') ? 'active' : '' }}">
                            <i class="bi bi-circle"></i><span>Danh mục</span>
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="{{ route('admin.comments.index') }}"
                            ...
                            <span>Đánh giá của sản phẩm</span>
                        </a>
                    </li>
                </ul>
            </li> --}}
            ...
            {{-- <li class="nav-item">
                <a class="nav-link cursor-pointer {{ Request::routeIs('admin.carts.*') || Request::routeIs('admin.orders.*') ? '' : 'collapsed' }}"
                    data-bs-target="#components-nav-3" data-bs-toggle="collapse">
                    <svg style="font-size: 16px; width: 20px; height: 20px; margin-right: 6px" viewBox="0 0 24 24"
                        fill="{{ Request::routeIs('admin.carts.*') || Request::routeIs('admin.orders.*') ? '#007bff' : '#899bbd' }}" xmlns="http://www.w3.org/2000/svg">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                        <g id="SVGRepo_iconCarrier">
                            <path
                    ...
                    <span>Đặt hàng</span><i class="bi bi-chevron-down ms-auto"></i>
                </a>
                <ul id="components-nav-3"
                    class="nav-content collapse {{ Request::routeIs('admin.carts.*', 'admin.orders.*') ? 'show' : '' }}"
                    data-bs-parent="#sidebar-nav-3">
                    <li>
                        <a href="{{ route('admin.carts.index') }}"
                            class="{{ Request::routeIs('admin.carts.*') ? 'active' : '' }}">
                            <i class="bi bi-circle"></i><span>Quản lý giỏ hàng</span>
                        </a>
                    </li>
                    <li>
            ...
            {{-- <li class="nav-item">
                <a class="nav-link cursor-pointer {{ Request::routeIs('admin.roles.*') || Request::routeIs('admin.users.*') ? '' : 'collapsed' }}"
                    data-bs-target="#components-nav-user" data-bs-toggle="collapse">
                    <i class="bi bi-person"></i>
                    <span>Tài khoản</span><i class="bi bi-chevron-down ms-auto"></i>
                </a>
                <ul id="components-nav-user"
                    class="nav-content collapse {{ Request::routeIs('admin.roles.*', 'admin.users.*') ? 'show' : '' }}"
                    data-bs-parent="#sidebar-nav-user">
                    <li>
