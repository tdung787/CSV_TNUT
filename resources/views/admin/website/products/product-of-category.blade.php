            ...
            <section class="collection-layout mt-3 mb-3">
                <div class="container">
                    <div
                        ...
                        @php
                            $productTests = [
                                ['src' => 'website/images/product_1.jpg', 'alt' => 'Banner 1'],
                                ['src' => 'website/images/product_2.jpg', 'alt' => 'Banner 2'],
                            ];
                        @endphp
                        ...
                        <div class="col-12 col-lg-9 order-lg-2 pt-3 pt-lg-0">
                            <div class="sortPagiBar pb-2 border-bottom">
                                <ul
                                    ...
                                    <li class="filter-item filter-item--check-box">
                                        <label class="d-flex align-items-baseline pt-1 pb-1 m-0">
                                            <input type="radio" class="d-none sortby-price-desc" name="sortBy"
                                                onclick="sortby('price-desc')" checked="true">
                                            <span class="fa2 px-2 py-1 rounded-10 border">Giá giảm dần</span>
                                        </label>
                                    </li>
                                    <li class="filter-item filter-item--check-box">
                                        <label class="d-flex align-items-baseline pt-1 pb-1 m-0">
                                            <input type="radio" class="d-none sortby-created-asc" name="sortBy"
                                ...
                                <div class="category-products position-relative mt-3">
                                    <div class="row slider-items mb-3">
                                        @foreach ($products as $product)
                                            <div class="col-lg-3 col-md-4 col-sm-6 col-6 product-grid-item-lm mb-3">
                                                <div
                                                    class="product-item position-relative p-2 rounded-10 bg-white h-100 border">

                                                    <!-- Hình ảnh sản phẩm -->
                                                    <a href="{{ route('web.product.show_only_product', ['category' => $category->slug, 'product' => $product->slug]) }}"
                                                    ...
                                                    <div class="item-info position-relative">
                                                        ...
                                                        <h3 class="item-title font-weight-normal m-0">
                                                            <a class="line_1"
                                                                href="{{ route('web.product.show_only_product', ['category' => $category->slug, 'product' => $product->slug]) }}"
                                                                title="{{ $product->name }}">
                                                                {{ $product->name }}
                                                            </a>
                                                        </h3>
                                        ...
                                        <ul class="pagination d-flex justify-content-center clearfix mt-4 mb-4">
                                            ...
                                            <li
                                                ...
                                                <a class="prev d-flex align-items-center justify-content-center page-link rounded-10 text-center"
                                                    href="{{ $products->previousPageUrl() }}" title="Trang trước">
