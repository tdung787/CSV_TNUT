...
<html lang="en">
  ...
  <body>
      <div class="container">
        ...
        <form enctype="multipart/form-data" action="{{route('alumni')}}" method="POST">
          @csrf
          ...
          @enderror
            ...
            <div class="input-box">
              ...
              <input name="ngaysinh" class="form-control" type="date" id="ngày-sinh" />
              @error('ngaysinh')
              <span class="fs-6 text-danger">{{$message}}</span>
          @enderror
            </div>
